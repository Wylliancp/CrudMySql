...
namespace CrudMySql.Repositorio
{
    public class Context : IDisposable
    {
        ...
        //public List<Dictionary<string, string>> ExecutaComandoComRetorno(string comandoSQL, SqlCommand parametros)
        //{
        //    List<Dictionary<string, string>> linhas = null;
        ...
        //    {
        //        AbrirConexao();
        //        //sqldr = parametros.ExecuteReader();

        //        var cmdComando = CriarComando(comandoSQL, parametros);
        //        using (var sqldr = parametros.ExecuteReader()) //(var reader = cmdComando.ExecuteReader())
        //        {
        //            linhas = new List<Dictionary<string, string>>();
        //            while (sqldr.Read())
        //            {
        ...
        //                for (var i = 0; i < sqldr.FieldCount; i++)
        //                {
        //                    var nomeDaColuna = sqldr.GetName(i);
        //                    var valorDaColuna = sqldr.IsDBNull(i) ? null : sqldr.GetString(i);
        //                    linha.Add(nomeDaColuna, valorDaColuna);
        //                }
        //                linhas.Add(linha);
        //            }
        ...
        //private MySqlCommand CriarComando(string comandoSQL, SqlCommand parametros)
        //{
        //    var cmdComando = conexao.CreateCommand();
        //    cmdComando.CommandText = comandoSQL;
        //    AdicionarParamatros(cmdComando, parametros);
